...
\instructions{Page budget for Results: 5 - 15 pages.
%
\begin{itemize}
...
\instructions{Explain the methodology used for collecting results and the metrics used for evaluation.}
